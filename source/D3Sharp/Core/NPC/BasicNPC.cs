...
namespace D3Sharp.Core.NPC
{
    public class BasicNPC
    {
        ...
        public BasicNPC(int objectId, ref GameClient g)
        {
            ID = objectId;
            Game = g;
            //Game.Game.SendMessage(new AffixMessage()
            //{
            //    Id = 0x48,
            //    Field0 = objectId,
            //    Field1 = 0x1,
            ...
            //    aAffixGBIDs = new int[0]
            //});
            //Game.Game.SendMessage(new ACDCollFlagsMessage
            //{
            //    Id = 0xa6,
            //    Field0 = objectId,
            //    Field1 = 0x1
            ...
            //Game.Game.SendMessage(new ACDGroupMessage
            //{
            //    Id = 0xb8,
            //    Field0 = objectId,
            ...
            //Game.Game.SendMessage(new ANNDataMessage
            //{
            //    Id = 0x3e,
            //    Field0 = objectId
            //});

            //Game.Game.SendMessage(new ACDTranslateFacingMessage
            //{
            //    Id = 0x70,
            //    Field0 = objectId,
            ...
            //Game.Game.SendMessage(new SetIdleAnimationMessage
            //{
            //    Id = 0xa5,
            //    Field0 = objectId,
            //    Field1 = 0x11150
            ...
            //Game.Game.SendMessage(new SNONameDataMessage
            //{
            //    Id = 0xd3,
            //    Field0 = new SNOName
            //    {
            ...
            //Game.packetId += 30 * 2;
            //Game.Game.SendMessage(new DWordDataMessage()
            //{
            //    Id = 0x89,
            ...
            //Game.tick += 20;
            //Game.Game.SendMessage(new EndOfTickMessage()
            //{
            //    Id = 0x008D,
            //    Field0 = Game.tick - 20,
            //    Field1 = Game.tick
